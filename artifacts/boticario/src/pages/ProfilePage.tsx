  ...
  return (
    <div className="bg-[#f6f7f7] min-h-screen pb-8 max-w-md mx-auto">
      ...
      <div className="px-4 mt-4 grid grid-cols-3 gap-3 mb-4">
        {[
          { label: "Vendas no Mês", value: "47" },
          { label: "Clientes", value: "23" },
          { label: "Fiados", value: "18" },
        ].map(s => (
          <div key={s.label} className="bg-white rounded-xl p-3 text-center border border-[#4d8063]/10 shadow-sm">
      ...
      <div className="px-4 space-y-2">
        {[
          ...
          { icon: "chat", label: "Cobranças WhatsApp", sub: "Enviar mensagens de cobrança", page: "cobranca" },
        ...
        <button className="w-full mt-2 py-4 border border-red-200 text-red-500 font-bold rounded-xl text-sm bg-white">
          Sair da Conta
        </button>
      </div>
    </div>
